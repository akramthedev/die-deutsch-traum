...
const tasksByDay = {
  ...
  "2024-12-14": ["Writing Task 2 : 30", "Writing Task 2 : 31","Writing Task 2 : 32", "Writing Task 2 : 33", "Writing Task 2 : 34", "Writing Task 2 : 35", "Writing Task 2 : 36", "Writing Task 2 : 37", "Writing Task 2 : 38", "Writing Task 2 : 39"],
  "2024-12-15": ["Writing Task 2 : 40", "Writing Task 2 : 41","Writing Task 2 : 42", "Writing Task 2 : 43", "Writing Task 2 : 44", "Writing Task 2 : 45", "Writing Task 2 : 46", "Writing Task 2 : 47", "Writing Task 2 : 48", "Writing Task 2 : 49"],
  "2024-12-16": ["Writing Task 2 : 50", "Writing Task 2 : 51","Writing Task 2 : 52", "Writing Task 2 : 53", "Writing Task 2 : 54", "Writing Task 2 : 55", "Writing Task 2 : 56", "Writing Task 2 : 57", "Writing Task 2 : 58", "Writing Task 2 : 59"],
  "2024-12-17": ["Grab telc B1 Zertifikat", "Writing Task 2 : 60", "Writing Task 2 : 61","Writing Task 2 : 62", "Writing Task 2 : 63", "Writing Task 2 : 64", "Writing Task 2 : 65", "Writing Task 2 : 66", "Writing Task 2 : 67", "Writing Task 2 : 68", "Writing Task 2 : 69"],
  "2024-12-18": ["Writing Task 2 : 70", "Writing Task 2 : 71","Writing Task 2 : 72", "Writing Task 2 : 73", "Writing Task 2 : 74", "Writing Task 2 : 75", "Writing Task 2 : 76", "Writing Task 2 : 77", "Writing Task 2 : 78", "Writing Task 2 : 79"],
  "2024-12-19": ["Writing Task 2 : 80", "Writing Task 2 : 81","Writing Task 2 : 82", "Writing Task 2 : 83", "Writing Task 2 : 84", "Writing Task 2 : 85", "Writing Task 2 : 86", "Writing Task 2 : 87", "Writing Task 2 : 88", "Writing Task 2 : 89"],
  "2024-12-20": ["Technopark Conference 16:00 -> 18:00 - check Gmail","Talk With Scolarité Settat - LST diplomate", "Writing Task 2 : 90", "Writing Task 2 : 91","Writing Task 2 : 92", "Writing Task 2 : 93", "Writing Task 2 : 94", "Writing Task 2 : 95", "Writing Task 2 : 96"],
  "2024-12-21": ["Watch This Video Before Taking any exam : https://youtu.be/xGtKdsVxV8A?si=w9vc3WmNN8lilg9j","Start Memorization of all writen data", "Register for IELTS exam", "END of Internship", "Starting IELTS EXAM preparation from tomorrow :)"],
};
